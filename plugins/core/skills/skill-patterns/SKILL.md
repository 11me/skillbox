---
name: skill-patterns
description: This skill should be used when the user asks to "improve skill quality", "add validation workflow", "define guardrails", or mentions "skill patterns", "Do/Verify/Repair", "skill contracts", "robust skills".
---
